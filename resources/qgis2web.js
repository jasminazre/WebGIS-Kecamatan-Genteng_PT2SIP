...
map.getView().fit([12546851.943865, -812521.788039, 12553732.409705, -808453.726999], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Keterjangkauan Halte Kecamatan Genteng</h2>';
        return titleElement;
    })(),
